sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("hcm.capr.ZHCMApprove.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias hcm.capr.ZHCMApprove.controller.ListSelector
			 */
			 ...
			 * @return {hcm.capr.ZHCMApprove.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
