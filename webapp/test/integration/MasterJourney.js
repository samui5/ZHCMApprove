...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Total less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Total>").
			and.iSelectListItemInViewSettingsDialog("<100 <Cyear>").
	...
	opaTest("MasterList Filtering on Total more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Cyear>").
			and.iPressOKInViewSelectionDialog();
